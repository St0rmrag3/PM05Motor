...
namespace PraktikaMotor
{
    ...
    public partial class ClientsSet
    {
        ...
        public ClientsSet()
        {
            this.NumbersSet = new HashSet<NumbersSet>();
            this.OrdersSet = new HashSet<OrdersSet>();
            this.SalesSet = new HashSet<SalesSet>();
            this.TradeInSet = new HashSet<TradeInSet>();
        }
        ...
        public virtual ICollection<NumbersSet> NumbersSet { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<OrdersSet> OrdersSet { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<SalesSet> SalesSet { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<TradeInSet> TradeInSet { get; set; }
    }
}
